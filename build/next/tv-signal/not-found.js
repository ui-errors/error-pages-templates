...
<head>
  ...
  <style>
    ...
    body {
      ...
      align-items: center;
      min-height: 100vh;
      background-color: #f0f0f0; /* Optional: adds a neutral background */
      overflow: hidden; /* Prevents scrollbars from large background text */
    }
    ...
    .text_404 {
      ...
      column-gap: 6em;
      z-index: -5;
      /* Center background text relative to wrapper */
      top: 50%;
      left: 50%;
      transform: translate(-50%, -50%);
      opacity: 0.2; /* Lowered slightly for better readability */
    ...
    .main {
      ...
      align-items: center;
      justify-content: center;
      /* Removed margin-top to keep it perfectly centered */
      position: relative;
    }
...
<body>
  <div class="main_wrapper">
    <div class="main">
      ...
      <div class="tv">
        <div class="cruve">
          <svg xml:space="preserve" viewBox="0 0 189.929 189.929" xmlns="http://www.w3.org/2000/svg" class="curve_svg">
